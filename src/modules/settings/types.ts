...
export const DEFAULT_SETTINGS: SettingDefaults = {
  ...
  "server.log_max_entries": { value: 1000, category: "server", description: "Max request log entries (ring buffer)" },
...
export const SETTING_VALIDATORS: Record<string, SettingValidator> = {
  ...
  'server.log_max_entries': { type: 'number', min: 100, max: 100000 },
