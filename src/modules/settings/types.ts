...
export const DEFAULT_SETTINGS: SettingDefaults = {
  ...
  "llm.gpu.layers": { value: 0, category: "llm", description: "GPU layers to offload (0=CPU only, -1=all)" },
  "llm.gpu.flash_attn": { value: "auto", category: "llm", description: "Flash Attention: on, off, auto" },
  "llm.gpu.split_mode": { value: "none", category: "llm", description: "GPU split: none, layer, row, tensor" },
  "llm.mtp.enabled": { value: false, category: "llm", description: "Enable Multi-Token Prediction (speculative decoding)" },
  "llm.mtp.draft_ngl": { value: 0, category: "llm", description: "GPU layers for MTP draft model" },
